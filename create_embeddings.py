...
def get_image_caption_embeddings(model, images, candidates, device, w=2.5):
    '''
...
def main():
    ...
    image_embed, candidate_embed = get_image_caption_embeddings(
    ...
    with open("image_embeddings.txt", 'w') as output:
        for row in image_embed:
            output.write(str(row) + '\n')

    with open("caption_embeddings.txt", 'w') as output:
        for row in candidate_embed:
            output.write(str(row) + '\n')
